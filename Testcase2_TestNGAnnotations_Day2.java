	...
	public class Testcase2_TestNGAnnotations_Day2 extends ProjectSpecificMethod {
		@Test

		public void creatNameandDetails() {
			...
			WebElement legalEntity = driver
					.findElement(By.xpath("//span[text()='More']/following::span[text()='Legal Entities']"));
			...
			name.sendKeys("Vishali Mahadevan1");
			WebElement comName = driver.findElement(By.xpath("//input[@name='CompanyName']"));
			comName.sendKeys("TestLeaf");
			WebElement descpt = driver.findElement(By.xpath("(//textarea[@class='slds-textarea'])[2]"));
			descpt.sendKeys("Salesforce");
			WebElement status = driver
					.findElement(By.xpath("//label[text()='Status']/following::button[@aria-haspopup='listbox']"));
